...
public class MultiplyCalculatorTestCaseImp extends TestCase implements CalculatorTestCase {
	...
	// constructors
	public MultiplyCalculatorTestCaseImp() {
	}

	public MultiplyCalculatorTestCaseImp(double primitive, Double object, Calculator<Double> calculator) {
	...
	public void testWithNoInput() {
		...
		Double actual = this.getCalculator().multiply();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = this.getCalculator().multiply(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = this.getCalculator().multiply(this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = this.getCalculator().multiply(this.getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = this.getCalculator().multiply(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = this.getCalculator().multiply(this.getPrimitive(), this.getPrimitive(), this.getPrimitive(), this.getPrimitive(), this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = this.getCalculator().multiply(this.getObject(), this.getObject(), this.getObject(), this.getObject(), this.getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = this.getCalculator().multiply(null, null, this.getPrimitive(), this.getPrimitive(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = this.getCalculator().multiply(this.getPrimitive(), this.getPrimitive(), this.getObject(), this.getObject(), this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = this.getCalculator().multiply(null, null, this.getPrimitive(), this.getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = this.getCalculator().multiply(null, null, this.getObject(), this.getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}