...
public class DivideCalculatorTestCase extends TestCase implements ICalculatorTestCase {
	...
	public void testWithNoInput() {
		...
		Double actual = getCalculator().divide();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = getCalculator().divide(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = getCalculator().divide(getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = getCalculator().divide(getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = getCalculator().divide(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = getCalculator().divide(getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = getCalculator().divide(getObject(), getObject(), getObject(), getObject(), getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = getCalculator().divide(null, null, getPrimitive(), getPrimitive(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = getCalculator().divide(getPrimitive(), getPrimitive(), getObject(), getObject(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = getCalculator().divide(null, null, getPrimitive(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = getCalculator().divide(null, null, getObject(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}