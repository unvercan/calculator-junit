...
public class AddCalculatorTestCaseImp extends TestCase implements CalculatorTestCase {
	...
	// constructors
	public AddCalculatorTestCaseImp() {
	}

	public AddCalculatorTestCaseImp(double primitive, Double object, Calculator<Double> calculator) {
	...
	public void testWithNoInput() {
		...
		Double actual = this.getCalculator().add();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = this.getCalculator().add(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = this.getCalculator().add(this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = this.getCalculator().add(this.getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = this.getCalculator().add(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = this.getCalculator().add(this.getPrimitive(), this.getPrimitive(), this.getPrimitive(), this.getPrimitive(), this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = this.getCalculator().add(this.getObject(), this.getObject(), this.getObject(), this.getObject(), this.getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = this.getCalculator().add(null, null, this.getPrimitive(), this.getPrimitive(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = this.getCalculator().add(this.getPrimitive(), this.getPrimitive(), this.getObject(), this.getObject(), this.getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = this.getCalculator().add(null, null, this.getPrimitive(), this.getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = this.getCalculator().add(null, null, this.getObject(), this.getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}