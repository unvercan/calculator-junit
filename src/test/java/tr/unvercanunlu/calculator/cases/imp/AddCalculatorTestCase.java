...
public class AddCalculatorTestCase extends TestCase implements ICalculatorTestCase {
	...
	public void testWithNoInput() {
		...
		Double actual = getCalculator().add();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = getCalculator().add(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = getCalculator().add(getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = getCalculator().add(getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = getCalculator().add(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = getCalculator().add(getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = getCalculator().add(getObject(), getObject(), getObject(), getObject(), getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = getCalculator().add(null, null, getPrimitive(), getPrimitive(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = getCalculator().add(getPrimitive(), getPrimitive(), getObject(), getObject(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = getCalculator().add(null, null, getPrimitive(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = getCalculator().add(null, null, getObject(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}