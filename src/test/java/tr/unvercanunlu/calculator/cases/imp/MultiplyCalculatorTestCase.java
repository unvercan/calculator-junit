...
public class MultiplyCalculatorTestCase extends TestCase implements ICalculatorTestCase {
	...
	public void testWithNoInput() {
		...
		Double actual = getCalculator().multiply();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = getCalculator().multiply(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = getCalculator().multiply(getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = getCalculator().multiply(getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = getCalculator().multiply(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = getCalculator().multiply(getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = getCalculator().multiply(getObject(), getObject(), getObject(), getObject(), getObject());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = getCalculator().multiply(null, null, getPrimitive(), getPrimitive(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = getCalculator().multiply(getPrimitive(), getPrimitive(), getObject(), getObject(), getPrimitive());
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = getCalculator().multiply(null, null, getPrimitive(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = getCalculator().multiply(null, null, getObject(), getObject(), null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}