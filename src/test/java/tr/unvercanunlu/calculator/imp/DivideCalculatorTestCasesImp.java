...
public class DivideCalculatorTestCasesImp extends TestCase implements CalculatorTestCases {
	...
	public void testWithNoInput() {
		...
		Double actual = this.calculator.divide();
	...
	public void testWithSingleNullInput() {
		Double expected = Double.NaN;
		Double input = null;
		Double actual = this.calculator.divide(input);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSinglePrimitiveInput() {
		...
		Double actual = this.calculator.divide(this.primitive);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithSingleObjectInput() {
		...
		Double actual = this.calculator.divide(this.object);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleNullInput() {
		Double expected = Double.NaN;
		Double actual = this.calculator.divide(null, null, null, null, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultiplePrimitiveInputs() {
		...
		Double actual = this.calculator.divide(this.primitive, this.primitive, this.primitive, this.primitive, this.primitive);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleObjectInputs() {
		...
		Double actual = this.calculator.divide(this.object, this.object, this.object, this.object, this.object);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndNullInputs() {
		...
		Double actual = this.calculator.divide(null, null, this.primitive, this.primitive, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveAndObjectInputs() {
		...
		Double actual = this.calculator.divide(this.primitive, this.primitive, this.object, this.object, this.primitive);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedPrimitiveObjectAndNullInputs() {
		...
		Double actual = this.calculator.divide(null, null, this.primitive, this.object, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
	...
	public void testWithMultipleMixedObjectAndNullInputs() {
		...
		Double actual = this.calculator.divide(null, null, this.object, this.object, null);
		assertEquals(expected, actual);
		assertNotNull(actual);
	}
}